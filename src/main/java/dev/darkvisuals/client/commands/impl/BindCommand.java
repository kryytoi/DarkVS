...
import dev.darkvisuals.client.managers.ModuleManager;
...
public class BindCommand extends Command {
    ...
    private int list(CommandContext<CommandSource> ctx) {
        ModuleManager mm = darkvisuals.getInstance().getModuleManager();
    ...
    private int set(CommandContext<CommandSource> ctx) {
        ...
        String moduleName = raw.substring(0, lastSpace).trim();
        String keyToken = raw.substring(lastSpace + 1).trim();
