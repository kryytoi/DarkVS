...
public class FriendsManager {
    ...
    public static void init(File globalsDir) {
     ...
     public static synchronized void importFromLauncher(File runDirectory) {
        if (runDirectory == null) return;

        File launcherFile = new File(runDirectory, "friends" + File.separator + "Friend.json");
        if (!launcherFile.exists()) return;
