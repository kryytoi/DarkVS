...
public class WorldParticles extends Module implements ThemeManager.ThemeChangeListener {
    ...
    private static final Identifier GLOW = darkvisuals.id("hud/glow.png");
    ...
    private boolean isInFrustum(Vec3d pos) {
        return ((dev.darkvisuals.mixin.accessors.IWorldRenderer) mc.worldRenderer)
                .getFrustum()
